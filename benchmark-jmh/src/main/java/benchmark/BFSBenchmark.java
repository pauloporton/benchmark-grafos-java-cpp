...
import algoritmos.java.BFS_Didatico;
...
public class BFSBenchmark {
    ...
    public List<Integer> benchmarkBFS() {
        ...
        for (int i = 1; i <= n; i++) {
            if (!usados[i]) {
                BFS_Didatico.bfs(grafo, caminhoPercorrido, usados, i);
            }
        }
