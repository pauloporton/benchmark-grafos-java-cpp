...
- [Conclusão](#conclusão)
- [Decisões metodológicas detalhadas](#decisões-metodológicas-detalhadas)
...
5. **Densidade máxima não testada** — Não foram testados grafos com densidade máxima (para mais detalhes, veja a explicação detalhada da densidade dos grafos na seção [Decisões metodológicas detalhadas](#decisões-metodológicas-detalhadas)).
